...
/**
 * Claude (Anthropic) brand icon from simple-icons
 */
export const ClaudeIcon: React.FC<BrandIconProps> = ({ className = 'w-4 h-4' }) => (
...
/**
 * OpenAI brand icon (used for Codex)
 */
export const OpenAIIcon: React.FC<BrandIconProps> = ({ className = 'w-4 h-4' }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
/**
 * Cursor brand icon from simple-icons
 */
export const CursorIcon: React.FC<BrandIconProps> = ({ className = 'w-4 h-4' }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M2.657 6.338h18.55c.263 0 .43.287.297.515L12.23 22.918c-.062.107-.229.064-.229-.06V12.335a.59.59 0 0 0-.295-.51l-9.11-5.257c-.109-.063-.064-.23.061-.23" />
  </svg>
);
