...
function validateContract(contract, schema) {
  ...
  for (const required of ['help', 'setup', 'install', 'update', 'version', 'doctor', 'daemon repair', 'agent-context', 'agents doctor', 'repos list', 'repos add', 'panes list', 'panes create', 'panels create', 'panels list', 'panels output', 'panels input', 'panels screen', 'panels submit', 'panels submit-composer', 'panels wait']) {
