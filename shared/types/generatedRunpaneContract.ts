...
export const RUNPANE_CONTRACT = {
  ...
  "commands": [
    ...
    {
      "name": "peers self",
      "summary": "Discover caller identity, available messaging capabilities and the optional Pi extension.",
      "usage": [
    ...
    {
      "name": "peers list",
      "summary": "List managed panels and registered peers with honest live receiver capabilities.",
      "usage": [
    ...
    {
      "name": "peers register",
      "summary": "Register any agent, including one outside a Pane terminal.",
      "usage": [
    ...
    {
      "name": "peers send",
      "summary": "Durably queue one idempotent task; a queued response is not consumption.",
      "usage": [
    ...
    {
      "name": "peers reply",
      "summary": "Reply to a claimed task as its recipient; terminal replies are immutable.",
      "usage": [
    ...
    {
      "name": "peers wait",
      "summary": "Quietly wait for a correlated blocked, failed or completed reply; --follow suppresses timeouts.",
      "usage": [
    ...
    {
      "name": "peers wake",
      "summary": "Attempt one guarded terminal inbox cue. A crash or uncertain write is never automatically replayed.",
      "usage": [
  ...
  "flags": {
    ...
    "localValue": [
      ...
      },
      {
        "name": "--peer",
        "value": "<id>",
        "description": "Caller identity; defaults to PANE_PEER_ID then PANE_PANEL_ID."
      },
      {
        "name": "--to",
        "value": "<id>",
        "description": "Recipient peer id from peers list."
      },
      {
        "name": "--id",
        "value": "<id>",
        "description": "Stable caller-supplied message id, reused only for the exact same task."
      },
      {
        "name": "--agent-label",
        "value": "<name>",
        "description": "Arbitrary runtime label; no brand allowlist."
      },
      {
        "name": "--receiver",
        "value": "<cooperative|pi>",
        "description": "Advertised receiver implementation; Pi is set by the optional native extension."
      },
      {
        "name": "--status",
        "value": "<blocked|completed|failed>",
        "description": "Task reply status. Completed does not imply reviewed, QA passed or merge ready."
      },
      {
        "name": "--after",
        "value": "<revision>",
        "description": "Return only a reply newer than this durable message revision."
      },
      {
        "name": "--quiet-panel",
        "value": "<panel-id>",
        "description": "Repeat to suppress inferred READY/IDLE for panels tracked with correlated peer waits. BLOCKED, STUCK and exits remain visible."
      }
    ],
    "localBoolean": [
      {
      ...
      },
      {
        ...
        "description": "Inspect queued, received and blocked inbox tasks for recovery; cannot combine with --claim."
      }
    ]
  },
  "help": {
    "npm": {
      "default": [
        ...
        "  runpane agent-context [--json]",
        "  runpane agents doctor --agent <codex|claude|cursor> [--repo <selector>] [--json]",
        "  runpane peers self --json  # discover identity, peers and communication",
      ...
      "watch": [
        ...
        "",
        "  --quiet-panel <panel-id>        Repeat for tasks tracked with peers wait; keeps blockers and exits."
      ],
      "panes create": [
        "Usage:",
        "  runpane panes create --repo <selector> --name <name> --agent <codex|claude|cursor> [options]",
      ...
      "peers self": [
        ...
        "  runpane peers self [--peer <id>] [--pane-dir <path>] [--json]",
        "",
        "Discover caller identity, available messaging capabilities and the optional Pi extension.",
        "",
        "Run \"runpane peers self --json\" for discovery. --peer identifies a local-user participant; it is not an authentication credential."
      ],
      "peers list": [
        "Usage:",
        "  runpane peers list [--peer <id>] [--pane-dir <path>] [--json]",
        "",
        "List managed panels and registered peers with honest live receiver capabilities.",
        "",
        "Run \"runpane peers self --json\" for discovery. --peer identifies a local-user participant; it is not an authentication credential."
      ],
      "peers register": [
        ...
        "  runpane peers register --peer <stable-id> --agent-label <name> [--receiver cooperative|pi] --yes [--pane-dir <path>] [--json]",
        "",
        "Register any agent, including one outside a Pane terminal.",
        "",
        "Run \"runpane peers self --json\" for discovery. --peer identifies a local-user participant; it is not an authentication credential."
      ],
      "peers send": [
        ...
        "  runpane peers send --to <peer> --id <request-id> (--text <text>|--input-file <path|->) --yes [--peer <id>] [--pane-dir <path>] [--json]",
        "",
        "Durably queue one idempotent task; a queued response is not consumption.",
        "",
        "Run \"runpane peers self --json\" for discovery. --peer identifies a local-user participant; it is not an authentication credential."
      ],
      "peers inbox": [
      ...
      "peers reply": [
        ...
        "  runpane peers reply --id <request-id> --status <blocked|completed|failed> (--text <text>|--input-file <path|->) --yes [--peer <id>] [--pane-dir <path>] [--json]",
        "",
        "Reply to a claimed task as its recipient; terminal replies are immutable.",
        "",
        "Run \"runpane peers self --json\" for discovery. --peer identifies a local-user participant; it is not an authentication credential."
      ],
      "peers wait": [
        ...
        "  runpane peers wait --id <request-id> [--after <revision>] [--timeout-ms <0-120000>] [--follow] [--peer <id>] [--pane-dir <path>] [--json]",
        "",
        "Quietly wait for a correlated blocked, failed or completed reply; --follow suppresses timeouts.",
        "",
        "Run \"runpane peers self --json\" for discovery. --peer identifies a local-user participant; it is not an authentication credential."
      ],
      "peers wake": [
        ...
        "  runpane peers wake --id <request-id> --yes [--peer <id>] [--pane-dir <path>] [--json]",
        "",
        "Attempt one guarded terminal inbox cue. A crash or uncertain write is never automatically replayed.",
        "",
        "Run \"runpane peers self --json\" for discovery. --peer identifies a local-user participant; it is not an authentication credential."
      ],
      "peers": [
        "Agent discovery and task communication:",
        "  runpane peers self --help",
        "  runpane peers list --help",
        "  runpane peers register --help",
        "  runpane peers send --help",
        "  runpane peers inbox --help",
        "  runpane peers reply --help",
        "  runpane peers wait --help",
        "  runpane peers wake --help"
      ]
    },
    "pip": {
      "default": [
  ...
  "agentContext": {
    ...
    "commands": {
      ...
      "peers self": {
        "name": "peers self",
        "summary": "Discover caller identity, available messaging capabilities and the optional Pi extension.",
        "details": "Discover caller identity, available messaging capabilities and the optional Pi extension. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": false,
        "arguments": [
          {
        ...
        "notes": [
          ...
          "A queued or received task is not completed; completed still requires workflow evidence."
        ]
      },
      "peers list": {
        "name": "peers list",
        "summary": "List managed panels and registered peers with honest live receiver capabilities.",
        "details": "List managed panels and registered peers with honest live receiver capabilities. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": false,
        "arguments": [
          {
      ...
      "peers register": {
        "name": "peers register",
        "summary": "Register any agent, including one outside a Pane terminal.",
        "details": "Register any agent, including one outside a Pane terminal. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": true,
        "arguments": [
          {
          ...
          {
            "name": "--yes",
            "description": "Confirm the requested mutation.",
            "required": false
          },
          {
            "name": "--pane-dir",
      ...
      "peers send": {
        "name": "peers send",
        "summary": "Durably queue one idempotent task; a queued response is not consumption.",
        "details": "Durably queue one idempotent task; a queued response is not consumption. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": true,
        "arguments": [
          {
      ...
      "peers inbox": {
        "name": "peers inbox",
        "summary": "Read or atomically claim queued tasks. Inspect received tasks after uncertain delivery; never reclaim automatically.",
        "details": "Read or atomically claim queued tasks. Inspect received tasks after uncertain delivery; never reclaim automatically. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": true,
        "arguments": [
          {
      ...
      "peers reply": {
        "name": "peers reply",
        "summary": "Reply to a claimed task as its recipient; terminal replies are immutable.",
        "details": "Reply to a claimed task as its recipient; terminal replies are immutable. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": true,
        "arguments": [
          {
      ...
      "peers wait": {
        "name": "peers wait",
        "summary": "Quietly wait for a correlated blocked, failed or completed reply; --follow suppresses timeouts.",
        "details": "Quietly wait for a correlated blocked, failed or completed reply; --follow suppresses timeouts. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": false,
        "arguments": [
          {
      ...
      "peers wake": {
        "name": "peers wake",
        "summary": "Attempt one guarded terminal inbox cue. A crash or uncertain write is never automatically replayed.",
        "details": "Attempt one guarded terminal inbox cue. A crash or uncertain write is never automatically replayed. Uses the existing daemon and durable sessions.db. Payloads: task <=32768 bytes, reply <=4096 bytes; use artifact references for longer output.",
        "requiresPaneDaemon": true,
        "mutates": true,
        "arguments": [
          {
